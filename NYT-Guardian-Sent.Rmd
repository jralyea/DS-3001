...
```{r TestChunk}
# Testing chunk
# This code is completely irrelevant to the task at hand,
# other than me testing random methods to complete the assignment
...
for (article in guardian_articles){
  guardian_tib <- guardian_tib %>%
    bind_rows(guardian_read(article))
}
